...
#   #Given the radius of a sphere calculate the volume
  def test_radius_of_sphere()
    volume_result = radius_of_cube(5)
    assert_equal( 523.599, volume_result)
  end

#   #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    fahrenheit_result = celsius(20)
    assert_equal(68, fahrenheit_result)
  end
end
